...
def divideintozones_v1(filename_gray,filename_mask,filename_bet,filename_csf_boundingbox):
    try:
...
#############################
        reader_csf_boundingbox = sitk.ImageFileReader()
        reader_csf_boundingbox.SetImageIO("NiftiImageIO")
        reader_csf_boundingbox.SetFileName(filename_csf_boundingbox)
        reader_csf_boundingbox_img = reader_csf_boundingbox.Execute()
        reader_csf_boundingbox_img_arr=sitk.GetArrayFromImage(reader_csf_boundingbox_img)
...
##############################
        ...
        for slice_num in range(filename_mask_img_arr.shape[0]):
            filename_mask_img_arr[slice_num,:,:][reader_csf_boundingbox_img_arr[slice_num,:,:]<np.max(reader_csf_boundingbox_img_arr[slice_num,:,:])]=np.min(filename_mask_img_arr)
