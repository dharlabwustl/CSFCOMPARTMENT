...
filled_contour_mask =fill_dilate_and_fill_3d_mask(ventricle_mask, dilation_iterations=10) #process_3d_binary_mask(ventricle_mask, sigma=1) # process_3d_binary_mask(ventricle_mask)
